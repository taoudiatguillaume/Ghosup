...
public class JFTraitementConsulter extends JFrame implements ActionListener, WindowListener
{
	...
	public JFTraitementConsulter(JFMenu jfMenu)
	{
		this.jfMenu = jfMenu;
		BDD.connecter("root", "");
		p = new Placeur(Paramètres.marge,Paramètres.largeur,Paramètres.hauteur,this);
	...
	// méthode appliquée sur signal en provenance de JFMenu suite à la validation d'une autre fenêtre
